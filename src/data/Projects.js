export const projects = [
  ...
  },
  {
    ...
    backEnd: 'Express, Express-session, bcrypt, JWT, MySQL, Heroku',
    desc: "I designed separate Forms table, Fields table, and Records table. Because the format and content of a medical form will change frequently per protocols, so this design will make it easier and cheaper to modify the forms, only need to insert rolls to Forms and Fields tables. When you select a form for a specific patient, if it's the first time to create this form, an empty form will be created, all you need to do is filling the form. Otherwise, the form will be displayed for the patient with these records.",
