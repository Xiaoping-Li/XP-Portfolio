  ...
  return (
    <div className="about">
      ...
      <div className="about-desc">
        ...
        <p>I have a Masters degree in Biochemistry and Melocular Biology from Fudan University of China, and almost 10 years' experience in this field.</p>
      </div>
    </div>
  );
}
